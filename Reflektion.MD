...
There are no built-in tests. Writing unit tests for each of the helper functions and the scrapeNextPage method would provide more reliability in funcitonality.
